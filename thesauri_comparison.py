...
if __name__=='__main__':
	...
	#############################################################
	method = args.method[0] if args.method !=None else None
	...
	# read files
	th1 = extract_terms(args.files[0], method, k)
	th2 = extract_terms(args.files[1], method, k)
	...
	print "*******************************"
	sim_score1 = neighbor_set_similarity(th1[i], th2[i], method, verbose=args.verbose)
